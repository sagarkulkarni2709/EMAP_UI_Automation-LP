...
public class HomePage {
	...
	private static By search_boxSiteType = By.xpath("//input[contains(@title,'Place or Address')]");
	...
	private static By siteType = By.xpath("//li[contains(text(),'Terminal')]");
	...
	public void SearchAddressWithSiteType(WebDriver driver, String address, BufferedWriter writer, ExtentTest test) throws Exception
	{
		try {
			...
			StepExecutor.ElementClick(driver, "Xpath", siteType, "Entity Type", writer, test);
